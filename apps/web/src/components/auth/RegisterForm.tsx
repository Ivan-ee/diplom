  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
      ...
      <button
        ...
        className="w-full bg-[var(--color-caramel)] hover:bg-[var(--color-caramel-hover)] text-white rounded-xl h-11 text-sm font-medium mt-4 transition-colors disabled:opacity-60 cursor-pointer"
      >
