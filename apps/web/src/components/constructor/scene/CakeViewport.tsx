    ...
    <div className="w-full h-full flex items-center justify-center bg-gradient-to-b from-gray-50 to-white">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="relative">
          <div className="w-32 h-8 rounded-full bg-[var(--color-soft-peach)] opacity-60 animate-pulse" />
          <div className="w-24 h-8 rounded-full bg-[var(--color-soft-peach)] opacity-50 animate-pulse mx-auto mt-1" />
          <div className="w-16 h-6 rounded-full bg-[var(--color-soft-peach)] opacity-40 animate-pulse mx-auto mt-1" />
        </div>
        <p className="text-sm text-[var(--color-text-secondary)] font-body animate-pulse">
